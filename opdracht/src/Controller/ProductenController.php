...
class ProductenController extends AbstractController
{
    ...
    {
        return $this->render('producten/index.html.twig', ['productens' => $productenRepository->findAll()]);
    }
    ...
    {
        return $this->render('producten/show.html.twig', ['producten' => $producten]);
    }
    ...
    public function edit(Request $request, Producten $producten): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('producten_index', ['id' => $producten->getId()]);
        }
